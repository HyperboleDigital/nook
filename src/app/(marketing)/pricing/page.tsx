...
const plans = [
  {
    ...
    tours: 1,
    features: ["1 3D tour", "Room Restyle with shop-the-look", "Public shareable links", "Standard resolution"],
  ...
  },
  {
    ...
    tours: 10,
    features: ["10 3D tours/mo", "Room Restyle with shop-the-look", "Public shareable links", "HD resolution", "Remove Nook watermark", "Email support"],
    cta: "Start Starter",
    highlight: true,
  },
  {
    ...
    tours: 30,
    features: ["30 3D tours/mo", "Room Restyle with shop-the-look", "Priority processing", "4K resolution", "Custom branding", "Priority support", "$3/extra tour"],
    cta: "Go Pro",
    highlight: false,
  },
];
